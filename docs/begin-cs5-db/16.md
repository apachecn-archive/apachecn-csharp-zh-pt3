...
![Image](img/square.jpg) **注意** IIS 是一个灵活、安全、易于管理的网络服务器，Windows 可以在网上托管任何东西。IIS 为其内部托管的 web 应用程序提供了完整的 web 管理工具。
...
![Image](img/square.jpg) **注意** IIS Express 是包含在 Visual Studio 2012 中的 IIS 的简化版。IIS Express 服务器为 IIS Express 中的 web 应用程序带来了大量管理功能。
