...
![Image](images/9781430242604_Tab10-01.jpg)
...
![Image](images/square.jpg) **提示**虽然我们在本书中不使用，但是如果使用命令行 C#编译器，可以使用以下编译器选项来包含所需程序集的引用:`/r:System.dll /r:System.Data.dll /r:System.Xml.dll`。
...
![Image](images/square.jpg) **注**各大 DBMS 厂商都支持自己的 ADO.NET 数据提供商。在本书中，我们将坚持使用 SQL Server，但是不管提供者是谁，都要编写相同类型的 C#代码。
...
![Image](images/9781430242604_Fig10-01.jpg)
...
![Image](images/9781430242604_Fig10-02.jpg)
...
![Image](images/9781430242604_Tab10-02.jpg)
...
![Image](images/9781430242604_Tab10-03.jpg)

![Image](images/9781430242604_Tab10-03a.jpg)
...
![Image](images/9781430242604_Tab10-04.jpg)
...
![Image](images/9781430242604_Tab10-05.jpg)
