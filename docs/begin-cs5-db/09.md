...
要使用 Windows 窗体，您需要使用 Visual Studio 2012 创建一个 Windows 窗体应用程序项目。为此，请单击开始所有程序 Visual Studio 2012，并从显示的列表中选择 Microsoft Visual Studio 2012。这将打开 Visual Studio 起始页。点击文件![Image](images/U001.jpg)新建![Image](images/U001.jpg)项目。现在你会看到新建项目对话框，你可以从中选择 Windows 窗体应用程序模板，如图[图 9-1](#fig_9_1) 所示。

![Image](images/9781430242604_Fig09-01.jpg)
...
![Image](images/9781430242604_Fig09-02.jpg)
...
![Image](images/9781430242604_Fig09-03.jpg)
...
![Image](images/9781430242604_Fig09-04.jpg)
...
![Image](images/square.jpg) **注**在[图 9-5](#fig_9_5) 中，我们有意将其他类别保持在折叠模式，只是为了向您展示所有类别。当您切换到 Categorized 视图时，您会看到默认情况下所有的类别都是展开的。

![Image](images/9781430242604_Fig09-05.jpg)
...
![Image](images/9781430242604_Fig09-06.jpg)
...
![Image](images/square.jpg) **注意**在某些情况下，您可能无法在 Visual Studio 中看到解决方案(`.sln`)文件。要列出一个解决方案文件，比如解决方案[第 9 章](09.html)(1 项目)，如图[图 9-7](#fig_9_7) 所示，你必须点击工具选项，转到项目和解决方案选项卡，选择常规，勾选“总是显示解决方案”选项，然后点击确定。
...
![Image](images/9781430242604_Fig09-07.jpg)
...
2.  Drag a Label control onto the form, and position it at the top middle of the form. Select this label, navigate to the Properties window, and set the following properties:
    ...
    ![Image](images/square.jpg) **提示**你也可以双击工具箱中的任意控件将其添加到表单中。拖动控件和双击控件的区别在于，在拖动时，可以根据需要在窗体上定位控件。但如果你只是双击一个控件，它会被添加到左上角；所以，如果你更喜欢它在不同的位置，你还是要把它拖到那里。
...
7.  Drag a Button control onto the form, and place it below the Label and TextBox controls. Select the Button control, go to the Properties window, change the Name property to btnSubmit, and then set its Text property to Submit.
    ...
    ![Image](images/9781430242604_Fig09-08.jpg)
...
8.  Double-click the Submit button. This will take you to the Code view, and you will see that the `btnSubmitClick` event template has been added to the Code view window. Now you will add the code to show a dialog box, with a greeting and welcome message for the entered first name and last name. To do so, you will use `MessageBox` class; this class provides a `Show()` function to display a dialog box with the provided information. Now let’s add the following code inside this `btnSubmitClick` event to achieve the desired functionality of a dialog, with a message, a caption in dialog box’s title bar, an OK button, a Cancel button, and an information icon displayed: `MessageBox.Show("Hello" + ' ' + txtFname.Text + ' ' + txtLname.Text + ' ' +
    ...
    ![Image](images/9781430242604_Fig09-09.jpg)
...
![Image](images/9781430242604_Fig09-10.jpg)

***图 9-10。**运行 Windows 应用程序表单*
...
![Image](images/square.jpg) **注意** `MessageBox.Show()`是非常强大和方便的功能；您可能希望更多地使用智能感知为`MessageBoxButtons`和`MessageBoxIcon`类型参数显示的各种选择。
...
![Image](images/9781430242604_Fig09-11.jpg)
...
![Image](images/9781430242604_Fig09-12.jpg)
...
3.  Similarly, grab the handle located on the bottom of the form and try to increase the height of the form. You will notice that the controls are still attached to the top side of the form.
    ...
    ![Image](images/9781430242604_Fig09-13.jpg)
...
9.  Select the Anchor property; modify its value from the default Top, Left to Top, Left, and Right. This will allow you to adjust the controls accordingly as soon as you resize the form. The controls will also grow in size accordingly to adjust to the width of the form, as you can see in [Figure 9-14](#fig_9_14). ![Image](images/9781430242604_Fig09-14.jpg)

    ***图 9-14。**Anchor 属性设置 Top，Left，Right 对调整大小后的表单的影响*

    ![Image](images/square.jpg) **注意**主播属性有非常有趣的行为；您可以尝试以各种组合设置该属性，并在调整窗体大小时查看效果。

10.  将窗体恢复到原来的大小，这样就可以看到设置另一个 Anchor 属性的效果。
11.  Select all the controls again as you did in step 8\. Set the Anchor property to Top only and try resizing the form now. You will notice that the controls are floating in the middle of the form when you resize it, as you can see in [Figure 9-15](#fig_9_15). ![Image](images/9781430242604_Fig09-15.jpg)

    ***图 9-15。**在调整大小后的窗体上设置 Top 的 Anchor 属性的效果*

12.  点击文件![Image](images/U001.jpg)全部保存，保存项目中的更改。
...
1.  导航到解决方案资源管理器并选择 WinApp 项目，右键单击，然后单击 Ad ![Image](images/U0901.jpg) Windows 窗体。这将在项目中添加一个新的 Windows 窗体。
...
14.  Drag a Button control next to the Remove State button; select this control, navigate to the Properties window, and set the following properties:
    ...
    ![Image](images/9781430242604_Fig09-16.jpg)
...
![Image](images/9781430242604_Fig09-17.jpg)
...
![Image](images/9781430242604_Fig09-18.jpg)
...
1.  导航到解决方案资源管理器，选择 WinApp 项目，右键单击，并选择 Ad ![Image](images/U0901.jpg) Windows 窗体。将名称值从`Form1.es`更改为`ParentForm.es`，并点击添加。
...
12.  Now build the solution, and run the application by pressing F5; the MDI application will open and should look like [Figure 9-19](#fig_9_19). ![Image](images/9781430242604_Fig09-19.jpg)
...
![Image](images/9781430242604_Fig09-20.jpg)
...
1.  In the project you modified in the previous exercise, you’ll first make the WinApp form an MDI child form. To do so, you need to set the `MdiParent` property of the child form’s object to the MDI parent form itself, but in the Code view. You have already added functionality in the previous task (opening the WinApp form); just before the line where you are calling the `Show()` method, add the following code (this code can be found under Win App menu click event): `                      objWA.MdiParent=this;
    ...
    ![Image](images/square.jpg) **注意** `this`是一个 C#语言关键字，表示类的当前实例。在这种情况下，它指的是 ParentForm。因为您是在 ParentForm 内部编写这段代码，所以您可以使用`this`关键字来完成同样的工作。
...
![Image](images/9781430242604_Fig09-22.jpg)

***图 9-22。**MDI 窗体应用程序的窗口菜单排列子窗体*
...
![Image](images/9781430242604_Fig09-23.jpg)
