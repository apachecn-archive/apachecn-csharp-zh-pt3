...
2.  从您安装的 SQL Server 2012 应用程序中打开 SQL Server Management Studio，在“连接到服务器”对话框中，输入 **localhost\ <您的服务器名称>** 作为服务器名称(参见[图 1-2](#fig_1_2) )。在某些情况下，您可能会看到 *localhost* 被一个点(.)或者真机名。(您可以从计算机属性中查看机器名称。)![Image](img/9781430242604_Fig01-02.jpg)
