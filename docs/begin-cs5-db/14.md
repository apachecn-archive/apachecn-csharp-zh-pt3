...
![Image](images/square.jpg) **提示**我们将在下一章进一步讨论的一点是选择数据读取器还是数据集。一般规则是总是使用数据读取器来简单地检索数据。如果你需要做的只是显示数据，那么在大多数情况下你需要使用的就是数据阅读器。
...
5.  Now your DataLooper form in the Design view should like [Figure 14-1](#fig_14_1). ![Image](images/9781430242604_Fig14-01.jpg)
...
6.  Double-click the empty surface of the DataLooper.cs form, and it will open the code editor window, showing the DataLooper_Load event. Modify the DataLooper_Load event to look like [Listing 14-1](#list_14_1).
    ...
    ***清单 14-1。**T4`DataLooper.cs`*
    ...
                }
         }`
7.  Build the project, and run the DataLooper form by pressing Ctrl+F5\. Your results should look like [Figure 14-2](#fig_14_2). ![Image](images/9781430242604_Fig14-02.jpg)
...
一旦调用了`Read`方法，下一行将作为集合返回并存储在`SqlDataReader`对象中。要访问特定列中的数据，可以使用许多方法(我们将在下一节中介绍这些方法)，但是对于这个应用程序，您使用序号索引器查找方法，将列号提供给读取器以检索值(就像您为数组指定索引一样)。因为在这种情况下，您在查询数据库时从 Customers 表中选择了一个单独的列，所以只有“zeroth”索引器是可访问的，所以您将该索引硬编码为`rdr[0]`。
...
1.  选择 DataReader 项目，右键单击，然后选择“添加![Image](images/U001.jpg) Windows 窗体”。在打开的对话框中，确保选择了 Windows 窗体，并将 Form1.cs 重命名为 OrdinalIndexer.cs 然后单击“确定”将该窗体添加到 DataReader 项目中。
...
3.  将 TextBox 控件拖到窗体上，并将其放在窗体的中央。选择此 TextBox 控件，导航到“属性”窗口，并设置以下属性:
    ...
    *   将文本属性留空。
4.  Now your OrdinalIndexer form in the Design view should like [Figure 14-3](#fig_14_3). ![Image](images/9781430242604_Fig14-03.jpg)
...
7.  Build the project, and run it by pressing Ctrl+F5\. You should see the results in [Figure 14-4](#fig_14_4). ![Image](images/9781430242604_Fig14-04.jpg)
...
![Image](images/9781430242604_Tab14-01.jpg)

![Image](images/9781430242604_Tab14-01a.jpg)

[表 14-2](#tab_14_2) 列出了一些可用的 OLE DB 数据类型，它们对应的。NET 类型以及它们的。NET 类型的访问器。

![Image](images/9781430242604_Tab14-02.jpg)

![Image](images/9781430242604_Tab14-02a.jpg)

![Image](images/9781430242604_Tab14-02b.jpg)
...
![Image](images/9781430242604_Tab14-03.jpg)

##### 试试看:使用类型化访问器方法

在此示例中，您将向 DataReader 项目添加一个 Windows 窗体，然后使用类型化访问器方法。

1.  选择 DataReader 项目，右键单击，然后选择“添加![Image](images/U001.jpg) Windows 窗体”。在打开的对话框中，确保选择了 Windows 窗体，并将 Form1.cs 重命名为 TypedAccessor.cs 单击“确定”将该窗体添加到 DataReader 项目中。
...
4.  Now your TypedAccessor form in the Design view should look like [Figure 14-5](#fig_14_5). ![Image](images/9781430242604_Fig14-05.jpg)
...
7.  Build the project, and run it by pressing Ctrl+F5\. You should see the results in [Figure 14-6](#fig_14_6). ![Image](images/9781430242604_Fig14-06.jpg)
...
![Image](images/9781430242604_Tab14-04.jpg)

##### 试试看:用数据阅读器获取结果集的信息

在本练习中，您将使用其中的一些方法和属性。

1.  选择 DataReader 项目，右键单击，然后选择“添加![Image](images/U001.jpg) Windows 窗体”。在打开的对话框中，确保选择了 Windows Form，并将 Form1.cs 重命名为 ResultSetInfo.cs 然后单击“确定”将该窗体添加到 DataReader 项目中。
...
3.  将 Label 控件拖到窗体上。选择该控件，导航到“属性”窗口，并设置以下属性:
    ...
    *   将 Size 属性的宽度设置为 335，高度设置为 13。
    *   将文本属性留空。
4.  Now your ResultSetInfo form in the Design view should like [Figure 14-7](#fig_14_7). ![Image](images/9781430242604_Fig14-07.jpg)
...
7.  Build the project, and run it by pressing Ctrl+F5\. Your results should look like [Figure 14-8](#fig_14_8). ![Image](images/9781430242604_Fig14-08.jpg)
...
1.  选择 DataReader 项目，右键单击，然后选择“添加![Image](images/U001.jpg) Windows 窗体”。在打开的对话框中，确保选择了 Windows 窗体，并将 Form1.cs 重命名为 SchemaTable.cs，然后单击 OK 将该窗体添加到 DataReader 项目中。
...
4.  Now your SchemaTable form in the Design view should look like [Figure 14-9](#fig_14_9). ![Image](images/9781430242604_Fig14-09.jpg)
...
7.  Build the project, and run it by pressing Ctrl+F5\. You should see the results in [Figure 14-10](#fig_14_10). ![Image](images/9781430242604_Fig14-10.jpg)
...
1.  选择 DataReader 项目，右键单击，然后选择“添加![Image](images/U001.jpg) Windows 窗体”。在打开的对话框中，确保选择了 Windows 窗体，并将 Form1.cs 重命名为 MultipleResults.cs，单击“确定”将该窗体添加到 DataReader 项目中。
...
4.  Now your MultipleResults form in the Design view should like [Figure 14-11](#fig_14_11). ![Image](images/9781430242604_Fig14-11.jpg)
...
7.  Build the project, and run it by pressing Ctrl+F5\. You should see the results in [Figure 14-12](#fig_14_12). ![Image](images/9781430242604_Fig14-12.jpg)
