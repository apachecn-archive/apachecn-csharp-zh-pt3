...
![Image](images/Solis42789fig0701.jpg)
...
![Image](images/Solis42789fig0702.jpg)
...
![Image](images/Solis42789fig0703.jpg)
...
       ↑
     Keyword` ![Image](images/Solis42789fig0704.jpg)
...
![Image](images/Solis42789fig0705.jpg)
...
   MyBaseClass mybc       = (MyBaseClass) derived;     // Cast the reference.` ![Image](images/Solis42789fig0706.jpg)
...
![Image](images/Solis42789fig0707.jpg)
...
![Image](images/Solis42789fig0708.jpg)
...
![Image](images/Solis42789fig0709.jpg)
...
![Image](images/Solis42789fig0710.jpg)
...
![Image](images/Solis42789fig0711.jpg)
...
![Image](images/square.jpg) **小心**在构造函数中调用虚方法*强烈不鼓励*。当执行基类构造函数时，基类中的虚方法将调用派生类中的重写方法。但那是在派生构造函数的主体被执行之前。因此，它会在类完全初始化之前向上调用派生类。
...
![Image](images/Solis42789fig0712.jpg)
...
![Image](images/Solis42789fig0713.jpg)
...
![Image](images/square.jpg) **注意**添加对另一个程序集的引用和添加一个`using`指令是两件不同的事情。添加对另一个程序集的引用会告诉编译器所需类型的定义位置。添加`using`指令允许您引用其他类，而不必使用它们的完全限定名。第 21 章对此有详细介绍。
...
![Image](images/Solis42789fig0714.jpg)
...
![Image](images/Solis42789fig0715.jpg)
...
   public int Member1;` ![Image](images/Solis42789fig0716.jpg)
...
![Image](images/Solis42789fig0717.jpg)
...
![Image](images/Solis42789fig0718.jpg)
...
![Image](images/Solis42789fig0719.jpg)
...
![Image](images/Solis42789fig0720.jpg)
...
![Image](images/Solis42789t0701.jpg)

[图 7-21](#fig_7_21) 显示了五个成员访问修饰符的相对可访问性。

![Image](images/Solis42789fig0721.jpg)
...
![Image](images/Solis42789t0702.jpg)
...
![Image](images/Solis42789t0703.jpg)
...
![Image](images/Solis42789fig0722.jpg)
...
![Image](images/Solis42789t0704.jpg)
