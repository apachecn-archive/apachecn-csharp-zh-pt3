...
![Image](images/square.jpg) **注意**要使用反射，必须使用`System.Reflection`名称空间。
...
![Image](images/Solis42789fig2402.jpg)
...
![Image](images/Solis42789fig2403.jpg)
...
![Image](images/Solis42789fig2404.jpg)
...
![Image](images/square.jpg) **注意**和方法一样，如果构造函数需要任何位置参数，它们必须放在任何命名参数之前。
