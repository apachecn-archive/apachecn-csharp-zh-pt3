...
   ![Image](images/Solis42789fig0801.jpg)
...
![Image](images/Solis42789fig0802.jpg)

***图 8-2。**真正的文字格式*

![Image](images/tab_8_2.jpg)

![Image](images/square.jpg) **注意**不带后缀的真实文字是`double`类型，不是`float`！
...
![Image](images/square.jpg) **注意**编译器通过让相同的字符串在堆中共享相同的内存位置来节省内存。
...
![Image](images/Solis42789fig0803.jpg)
...
![Image](images/tab_8_8.jpg)

带有关系或相等运算符的二元表达式返回一个类型为`bool.`的值

![Image](images/square.jpg) **注意**与 C 和 C++不同，C#中的数字没有布尔解释。
...
![Image](images/Solis42789fig0804.jpg)
...
![Image](images/Solis42789fig0806.jpg)
...
![Image](images/Solis42789fig0807.jpg)

***图 8-7。**左移三位的例子*

[图 8-8](#fig_8_8) 说明了按位移位操作。

![Image](images/Solis42789fig0808.jpg)
...
![Image](images/Solis42789fig0809.jpg)
...
![Image](images/Solis42789fig0810.jpg)
...
![Image](images/square.jpg) **注**`if...else`语句是一条控制流*语句*。它应该用于*执行*两个*动作中的一个或另一个。*条件运算符返回一个*表达式。*用于*返回*两个*值*中的一个或另一个。
...
![Image](images/square.jpg) **注意**你的重载操作符要符合操作符的直观含义。
