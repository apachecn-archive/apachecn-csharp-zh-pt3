...
![Image](images/square.jpg) **注意**关于`Parse`的一个常见误解是，由于它对字符串进行操作，所以它被认为是`string`类的成员。不是的。`Parse`根本不是单一的方法，而是由*目标*类型实现的许多方法。
...
![Image](images/Solis42789fig2501.jpg)
...
         ...` ![Image](images/Solis42789fig2502.jpg)
...
![Image](images/Solis42789fig2503.jpg)
...
![Image](images/Solis42789fig2504.jpg)
...
![Image](images/Solis42789fig2505.jpg)
...
![Image](images/Solis42789fig2506.jpg)
...
![Image](images/square.jpg) **注**在 3.0 版本发布之前，析构函数有时被称为*终结器*。你有时可能仍然会在文献和。NET API 方法名。
...
![Image](images/p714-01.jpg)

![Image](images/Solis42789fig2507.jpg)
...
![Image](images/Solis42789fig2508.jpg)

***图 25-8。**要求将字符串发送到 Word 拼写检查器的控制台窗口*

![Image](images/Solis42789fig2509.jpg)
