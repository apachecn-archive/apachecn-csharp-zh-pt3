...
| 图表 | 带代码格式的类型 |
| :-- | :-- |
| ![A460204_1_En_3_Figa_HTML.jpg](A460204_1_En_3_Figa_HTML.jpg) | 单继承:`#region Single Inheritance``class Parent``{``//Some code``}``class Child : Parent``{``//Some code``}``#endregion` |
| ![A460204_1_En_3_Figb_HTML.jpg](A460204_1_En_3_Figb_HTML.jpg) | 分层继承:`#region Hierarchical Inheritance``class Parent``{``//Some code``}``class Child1 : Parent``{``//Some code``}``class Child2 : Parent``{``//Some code``}``#endregion` |
| ![A460204_1_En_3_Figc_HTML.jpg](A460204_1_En_3_Figc_HTML.jpg) | 多级继承:`#region Multilevel Inheritance``class Parent``{``//Some code``}``class Child : Parent``{``//Some code``}``class GrandChild : Child``{``//Some code``}``#endregion` |
| ![A460204_1_En_3_Figd_HTML.jpg](A460204_1_En_3_Figd_HTML.jpg) | 多重继承:在 C#中不支持通过类继承。我们需要了解接口。下面举个例子:`#region Multiple Inheritance``interface``IInter1``{``//Some Code``}``interface``IInter2``{``//Some code``}``class MyClass : IInter1, IInter2``{``//Some code``}``#endregion` |
...
![A460204_1_En_3_Fige_HTML.jpg](A460204_1_En_3_Fige_HTML.jpg)
...
![A460204_1_En_3_Figf_HTML.jpg](A460204_1_En_3_Figf_HTML.jpg)
...
![A460204_1_En_3_Figg_HTML.jpg](A460204_1_En_3_Figg_HTML.jpg)
...
![A460204_1_En_3_Figh_HTML.jpg](A460204_1_En_3_Figh_HTML.jpg)
...
![A460204_1_En_3_Figi_HTML.jpg](A460204_1_En_3_Figi_HTML.jpg)
...
![A460204_1_En_3_Figj_HTML.jpg](A460204_1_En_3_Figj_HTML.jpg)
...
![A460204_1_En_3_Figk_HTML.jpg](A460204_1_En_3_Figk_HTML.jpg)
...
![A460204_1_En_3_Figl_HTML.jpg](A460204_1_En_3_Figl_HTML.jpg)
...
老师说:你试图在这里引入方法覆盖的概念。我们将在关于多态性的章节中进一步讨论它。但是要回答您的问题，请考虑下面的程序和输出。
...
![A460204_1_En_3_Figm_HTML.jpg](A460204_1_En_3_Figm_HTML.jpg)

### 分析

在这种情况下，您的程序被编译并运行，但是您应该注意到您会收到一条警告消息，提示您的派生类方法隐藏了继承的父类方法，如下所示:

![A460204_1_En_3_Fign_HTML.jpg](A460204_1_En_3_Fign_HTML.jpg)

因此，如果您想调用父类方法，您可以简单地使用子类方法中的代码，就像这样:

![A460204_1_En_3_Figo_HTML.jpg](A460204_1_En_3_Figo_HTML.jpg)
...
先生，如果一个用户已经为他的应用程序创建了一个方法，我们应该通过继承的概念来重用同一个方法，以避免重复工作。这种理解正确吗？
