...
![9781430249351_Fig11-01.jpg](images/9781430249351_Fig11-01.jpg)
...
![9781430249351_Fig11-02.jpg](images/9781430249351_Fig11-02.jpg)
...
![9781430249351_Fig11-03.jpg](images/9781430249351_Fig11-03.jpg)
...
![9781430249351_Fig11-04.jpg](images/9781430249351_Fig11-04.jpg)
...
![9781430249351_Fig11-05.jpg](images/9781430249351_Fig11-05.jpg)

[图 11-5](#_Fig5) 。在 XAML 编辑器中连接事件处理程序

![9781430249351_Fig11-06.jpg](images/9781430249351_Fig11-06.jpg)
...
在下面的活动中，您将使用表单和控件构建一个简单的备忘录查看器应用程序，该应用程序允许用户加载和查看备忘录文档。
...
9.  Note that as you add the XAML, the Visual Designer updates the appearance of the window. The Memo Viewer window should look similar to the one shown [Figure 11-7](#Fig7).
    ...
    ![9781430249351_Fig11-07.jpg](images/9781430249351_Fig11-07.jpg)
...
8.  选择调试![image](images/arrow.jpg)开始。通过加载 Test.txt 文件来测试应用程序。查看文件后，单击退出菜单关闭窗口。
...
![9781430249351_Fig11-08.jpg](images/9781430249351_Fig11-08.jpg)

[图 11-8](#_Fig8) 。“新建项目”对话框

![9781430249351_Fig11-09.jpg](images/9781430249351_Fig11-09.jpg)
...
![9781430249351_Fig11-10.jpg](images/9781430249351_Fig11-10.jpg)
...
![9781430249351_Fig11-11.jpg](images/9781430249351_Fig11-11.jpg)
...
![9781430249351_Fig11-12.jpg](images/9781430249351_Fig11-12.jpg)
...
![9781430249351_Fig11-13.jpg](images/9781430249351_Fig11-13.jpg)
...
10.  The visual editor contains an authors table. Select the authorsTableAdapter, as shown in [Figure 11-14](#Fig14). In the Properties window, notice that the select, insert, update, and delete commands have been generated for you (see [Figure 11-15](#Fig15)).
    ...
    ![9781430249351_Fig11-14.jpg](images/9781430249351_Fig11-14.jpg)

    [图 11-14](#_Fig14) 。选择 authorsTableAdapter

    ![9781430249351_Fig11-15.jpg](images/9781430249351_Fig11-15.jpg)
...
5.  选择调试![image](images/arrow.jpg)开始。单击“获取数据”按钮测试应用程序。数据网格将加载作者的数据(见[图 11-16](#Fig16) )。请注意，由于 DataGrid 的`AutoGenerateColumns`属性被设置为 true，因此网格将加载表中的所有列。网格列的标题也与作者的表格列同名。
6.  After viewing the window, stop the debugger.

    ![9781430249351_Fig11-16.jpg](images/9781430249351_Fig11-16.jpg)
...
3.  选择调试![image](images/arrow.jpg)开始。单击“获取数据”按钮测试应用程序。更新一些名字。单击“保存数据”按钮，然后单击“获取数据”按钮，验证名称是否已保存到数据库中。
...
![9781430249351_Fig11-17.jpg](images/9781430249351_Fig11-17.jpg)
...
![9781430249351_Fig11-18.jpg](images/9781430249351_Fig11-18.jpg)
...
![9781430249351_Fig11-19.jpg](images/9781430249351_Fig11-19.jpg)
...
5.  选择调试![image](images/arrow.jpg)开始。确保列表框显示商店名称。查看完列表框后，停止调试器。
...
8.  Launch the application in the debugger. Your window should look similar to [Figure 11-20](#Fig20). Click on different stores in the list box. You should see the data grid update with the store’s sales data. After testing, stop the debugger and close Visual Studio.
    ...
    ![9781430249351_Fig11-20.jpg](images/9781430249351_Fig11-20.jpg)
